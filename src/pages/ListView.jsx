...
const ListView = ({handleOrderPopup}) => {
  return (
    <>
    <div className='dark:bg-gray-900 dark:text-white bg-gray-50 py-10 mt-10'>
        <section data-aos="fade-up" className='container'>
  <h1 className='my-8 border-l-8 border-primary/50 py-2 pl-2 text-3xl text-gray-800 font-bold'>List Of Place</h1>
